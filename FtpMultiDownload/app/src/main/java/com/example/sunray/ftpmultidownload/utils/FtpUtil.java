...
public class FtpUtil {
    ...
    public static boolean login(FTPClient ftpClient,String url,int port,String username,String password) {
        try {
    ...
    public static DownloadStatus download(FTPClient ftpClient,String remoteFilePath,String localFilePath) throws IOException {
